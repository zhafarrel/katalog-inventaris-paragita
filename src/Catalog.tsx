...
export default function Catalog({ isDarkMode, setIsDarkMode }: { isDarkMode: boolean, setIsDarkMode: (val: boolean) => void }) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3 w-full md:w-auto">
              ...
              {/* Hidden Admin Button - Only visible on hover/focus for easy access in preview */}
              <button
                onClick={() => window.location.href = '/admin'}
                className="p-2.5 rounded-xl text-transparent hover:text-gray-400 dark:hover:text-gray-600 transition-colors flex-shrink-0"
